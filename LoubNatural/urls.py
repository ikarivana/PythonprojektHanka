...
from viewer.views import (
    home, search_view, name_day, PedicureListView, PedicureDetailView, PedicureCreateView, PedicureUpdateView,
    PedicureDeleteView, EyelashListView, EyelashDetailView, EyelashCreateView, EyelashUpdateView, EyelashDeleteView,
    HealthListView, HealthDetailView, HealthCreateView, HealthUpdateView, HealthDeleteView, ContactListView,
    ContactDetailView, ContactCreateView, ContactUpdateView, ContactDeleteView, ImageCreateView, ImageListView,
    ImageDetailView, ImageUpdateView, ImageDeleteView, OrderListView, OrderCreateView, seznam_novinek, detail_novinky,
    pridat_novinku, smazat_novinku, RegisterView
